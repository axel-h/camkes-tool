...
/*- for i in instances if not i.type.hardware -*/
    ...
    # Generate a generic camkes.h, which includes all other headers in the
    # correct order
    ...
    # It's unclear if for camkes.c we really have to explicitly define a
    # dependency on camkes.h and ${camkes_component_h}. Without this, the file
    # ninja.rules does not list any explicit dependency for camkes.c, but
    # .ninja_deps seems to contain a reference.
    set_property(
        SOURCE /*? i.name ?*//camkes.c
        PROPERTY OBJECT_DEPENDS
            ${generated_dir}/include/camkes.h
            ${generated_dir}/include/${camkes_component_h}
    )
